...
const CONTENT: Record<string, { title: string; description: string; body: string[]; read: string }> = {
  ...
  "earn-renting-land-ev-charging": {
    ...
    body: [
      ...
      "Earnings depend on footfall, charger type and location. Sites with steady dwell time, such as shopping malls, highway restaurants, and residential societies, see higher utilisation and therefore higher revenue.",
  ...
  "ac-vs-dc-charging": {
    ...
    read: "6 min read",
    body: [
      "AC chargers (7.4–22 kW, Type-2) are destination chargers: they take 2–8 hours for a full charge and suit places where vehicles park for a while, such as apartments, offices and hotels. They start from around ₹1.5 lakh.",

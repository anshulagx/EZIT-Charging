  ...
  return (
    <div>
      <PageHero
        ...
        title={
          <>
            How <span className="text-ezit-green">EZIT</span> works
          </>
        }
      ...
      >
        <div className="relative">
          <div
            className="hidden lg:block absolute top-[2.25rem] left-[12%] right-[12%] h-px bg-gradient-to-r from-transparent via-ezit-green/35 to-transparent pointer-events-none"
            aria-hidden
          />
